...
<body>
            ...
            <div class="sidebar offcanvas offcanvas-start bg-dark" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item mx-4 fs-5 ">
                            <a class="nav-link " href="datapekerja.php">Data Pekerja</a>
                        </li>

                        <li class="nav-item mx-4 fs-5">
                            <a class="nav-link active" href="datakebun.php">Data Kebun</a>
                        </li>
    ...
    <div class="container">
        ...
        <a href="kelolapemasukan.php" type="button" class="btn btn-primary mb-3 ms-1">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <center><?php echo $result['ket'] ?></center>
                            </td>
                            <td>
                                <center><?php echo $result['berat'] ?></center>
                            </td>
                            <td>
                                <center><?php echo $result['total'] ?></center>
                            </td>
                            <td>
                                <center>
                                    <a href="kelolapemasukan.php?ubah=<?php echo $result['id'] ?>" type="button" class="btn btn-success btn-sm">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <a href="prosespemasukan.php?hapus=<?php echo $result['id'] ?>" type="button" class="btn btn-danger btn-sm" onclick="return confirm('Apakah kamu yakin ingin menghapus data tersebut ?')">
