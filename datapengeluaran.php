...
<body>
            ...
            <div class="sidebar offcanvas offcanvas-start bg-dark" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item mx-4 fs-5">
                            <a class="nav-link active" href="datapengeluaran.php">Data Pengeluaran</a>
                        </li>
    ...
    <!-- Judul-->
    <div class="container">
        <h1 class="mt-5 pt-5 text-light ps-1">Data Pengeluaran</h1>

        <a href="kelolapengeluaran.php" type="button" class="btn btn-primary mb-3 ms-1">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="kelolapengeluaran.php?ubah=<?php echo $result['id_pengeluaran'] ?>" type="button" class="btn btn-success btn-sm">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <a href="prosespengeluaran.php?hapus=<?php echo $result['id_pengeluaran'] ?>" type="button" class="btn btn-danger btn-sm" onclick="return confirm('Apakah kamu yakin ingin menghapus data tersebut ?')">
