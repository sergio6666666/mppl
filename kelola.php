...
if (isset($_GET['ubah'])) {
    ...
    $query =  "SELECT * FROM tb_pemasukan WHERE id_pemasukan = '$id';";
...
<body>
            ...
            <div class="sidebar offcanvas offcanvas-start bg-dark" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item mx-4 fs-5 ">
                            <a class="nav-link active" href="datapekerja.php">Data Pemasukan</a>
                        </li>

                        <li class="nav-item mx-4 fs-5">
                            <a class="nav-link " href="datakebun.php">Data Pengeluaran</a>
                        </li>
    ...
    <div class="container d-flex justify-content-center" style="min-height: auto;">
        <form method="POST" action="proses.php" enctype="multipart/form-data" style="background-color: #fff; padding: 20px; border-radius: 10px; width: 100%; max-width: 700px;">
            <input type="hidden" value="<?php echo $id ?>" name="id_pemasukan">
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input required type="date" name="tanggal" class="form-control bg-white text-black" id="tanggal"  value="<?php echo $tanggal; ?>" autocomplete="off">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label text-black">Keterangan</label>
                <div class="col-sm-10">
                    <input required type="text" name="nama" class="form-control bg-white text-black" id="nama" placeholder="Masukkan keterangan" value="<?php echo $nama; ?>" autocomplete="off">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="jumlah" class="col-sm-2 col-form-label text-black">Jumlah</label>
                <div class="col-sm-10">
                    <input required type="text" name="jumlah" class="form-control bg-white text-black" id="jumlah" placeholder="Masukkan jumlah" value="<?php echo $jumlah; ?>" autocomplete="off">
                </div>
            </div>
            ...
            <div class="mb-3 row mt-4 d-flex justify-content-center">
                <div class="col text-center">
                    ...
                    <?php } ?>
                    <a href="datapemasukan.php" type="button" class="btn btn-danger">
